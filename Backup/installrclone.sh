...
if [ -z "$install_beta" ]; then
    current_version=$(curl -fsS https://raw.githubusercontent.com/takbebeh/rclone/main/stable/version.txt)
else
    current_version=$(curl -fsS https://raw.githubusercontent.com/takbebeh/rclone/main/beta/version.txt)
fi
...
#download and unzip
if [ -z "$install_beta" ]; then
    download_link="https://raw.githubusercontent.com/takbebeh/rclone/main/stable/rclone-current-${OS}-${OS_type}.zip"
    rclone_zip="rclone-current-${OS}-${OS_type}.zip"
else
    download_link="https://raw.githubusercontent.com/takbebeh/rclone/main/beta/rclone-beta-latest-${OS}-${OS_type}.zip"
